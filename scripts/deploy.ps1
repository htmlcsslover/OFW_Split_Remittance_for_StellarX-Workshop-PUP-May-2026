...
Write-Host "Initialising FundPool..."
try {
  stellar contract invoke --id $ContractId --source-account $Identity --network $Network -- init --admin $AdminAddress --asset $AdminAddress
} catch {
